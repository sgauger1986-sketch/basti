...
| Ordner | Inhalt |
|---|---|
| [`mobile/`](mobile/) | **Native App für iOS und Android** (Expo / React Native). Projekte, Leistungsverzeichnisse, Rapporte mit Fotos und GPS, Adressen, Stammdaten. Offline-fähig, komplett verschlüsselt (siehe [`mobile/docs/SICHERHEIT.md`](mobile/docs/SICHERHEIT.md)), Demo-Modus, Server-Anbindung nach [`mobile/docs/API.md`](mobile/docs/API.md). |
